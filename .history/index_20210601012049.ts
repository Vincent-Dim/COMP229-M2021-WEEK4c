...
{
  res.setHeader('Content-Type', 'text/html'); //sets up page header
  displayHome(res);         // response (of type text/html) is passed into the displayHome function (defined below), which writes out to the web page
});
